        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all scale-100">
            ...
            <div className="p-6">
              ...
              {unidadSeleccionada.plan_clave && (
                <div className="mt-6 border-l-4 border-yellow-600 bg-yellow-50 p-4 rounded-r-lg">
                  <div className="flex items-start gap-3">
                    {/* Icono de Balanza o Institucional */}
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-yellow-800 uppercase tracking-wide">
                        Unidad Prioritaria: Plan de Justicia
                      </h4>
                      <p className="text-xs text-yellow-900 font-bold mt-1">
                        CLAVE: {unidadSeleccionada.plan_clave}
                      </p>
                      <p className="text-sm text-gray-700 mt-1 leading-relaxed">
                        {unidadSeleccionada.plan_desc}
                      </p>
                    </div>
                  </div>
                </div>
